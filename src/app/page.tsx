    ...
    <div className="min-h-screen bg-gray-50 scroll-smooth">
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center max-w-4xl">
          <Badge className="mb-6 bg-primary/10 text-primary hover:bg-slate-100">
            🚀 Now in Beta - Join the Waitlist
          </Badge>
          <h1 className="text-5xl md:text-6xl font-black mb-6 text-primary leading-tight text-balance">
      ...
      <section id="features" className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black mb-4 text-balance text-primary">
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-4xl font-black mb-6 text-balance text-primary">
      ...
      {/* <section id="demo" className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="bg-gray-50 rounded-2xl p-12 border-2 border-dashed border-gray-300">
            ...
            <Button className="bg-primary hover:bg-slate-800 text-white">
              Request Demo Access
            </Button>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="border-2 border-slate-900 relative hover:border-slate-700 transition-colors">
              ...
              <CardContent>
                ...
                <Button className="w-full mt-6 bg-primary hover:bg-slate-800 text-white">
                  Start Free Trial
                </Button>
              </CardContent>
            </Card>
